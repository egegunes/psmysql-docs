...
The new cache stores dictionary data in memory, making lookups faster than the previous method of querying the `mysql.masking_dictionaries` table each time. This speed boost is especially noticeable when you're working with many rows of data.
